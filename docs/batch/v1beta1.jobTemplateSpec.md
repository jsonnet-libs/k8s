...
[`fn spec.withBackoffLimit`](#fn-specwithbackofflimit)  
[`fn spec.withCompletions`](#fn-specwithcompletions)  
[`fn spec.withManualSelector`](#fn-specwithmanualselector)  
[`fn spec.withParallelism`](#fn-specwithparallelism)  
[`fn spec.withTtlSecondsAfterFinished`](#fn-specwithttlsecondsafterfinished)  

---


### `fn new`
new returns an instance of Jobtemplatespec
```jsonnet
{
  new(name):: {}
}

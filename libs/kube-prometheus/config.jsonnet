...
config.new(
  ...
  specs=[
    ...
    },
    {
      ...
      prefix: '^com\\.coreos\\.monitoring\\..*',
      crds: [
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0alertmanagerConfigCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0alertmanagerCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0podmonitorCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0probeCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0prometheusCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0prometheusagentCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0prometheusruleCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0scrapeconfigCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0servicemonitorCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.14/manifests/setup/0thanosrulerCustomResourceDefinition.yaml',
      ],
      localName: 'kube_prometheus',
      patchDir: 'custom',
    },
    {
      ...
      prefix: '^com\\.coreos\\.monitoring\\..*',
      crds: [
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0alertmanagerConfigCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0alertmanagerCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0podmonitorCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0probeCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0prometheusCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0prometheusagentCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0prometheusruleCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0scrapeconfigCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0servicemonitorCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.15/manifests/setup/0thanosrulerCustomResourceDefinition.yaml',
      ],
      localName: 'kube_prometheus',
      patchDir: 'custom',
    },
    {
      ...
      prefix: '^com\\.coreos\\.monitoring\\..*',
      crds: [
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0alertmanagerConfigCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0alertmanagerCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0podmonitorCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0probeCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0prometheusCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0prometheusagentCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0prometheusruleCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0scrapeconfigCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0servicemonitorCustomResourceDefinition.yaml',
        'https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/release-0.16/manifests/setup/0thanosrulerCustomResourceDefinition.yaml',
      ],
      localName: 'kube_prometheus',
      patchDir: 'custom',
    },

...
local podMetricsEndpoint = {
  '#':: d.pkg(name='podMetricsEndpoint', url='', help='PodMetricsEndpoint defines a scrapeable endpoint of a Kubernetes Pod serving Prometheus metrics.'),
  ...
  '#withPort':: d.fn('Name of the pod port this endpoint refers to. Mutually exclusive with targetPort.', [d.arg('port', d.T.string)]),
  withPort(port): { port: port },

  '#withTargetPort':: d.fn('Deprecated: Use ‘port’ instead.', [d.arg('port', d.T.int)]),
